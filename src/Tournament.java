...
public class Tournament {
	 ...
	 * [first player: human/whatever/naive/smart]
	 * [second player: human/whatever/naive/smart]
	 * Example:
	 * java Tournament 100 4 3 console smart naive
	 *
	 ...
	 *             args[4] - Type of the first player (e.g., "human" or "smart").
	 *             args[5] - Type of the second player (e.g., "human" or "naive").
	 */
	...
	public void playTournament(int size, int winStreak, String playerName1, String playerName2) {
		...
		displayResults(playerName1, playerName2, player1Wins, player2Wins, ties);
	}

	/*
	 * Displays the final results of the tournament.
	 *
	 * @param playerName1 name of the first player
	 * @param playerName2 name of the second player
	 * @param player1Wins number of wins for the first player
	 * @param player2Wins number of wins for the second player
	 * @param ties        number of tied games
	 */
	private static void displayResults(String playerName1, String playerName2, int player1Wins,
									   int player2Wins, int ties) {
		// Display the final results of the tournament, in the format:
		// ######### Results #########
		// Player 1, [playerName1] won: [player1Wins] rounds
		// Player 2, [playerName2] won: [player2Wins] rounds
		// Ties: [ties]
